...
export const SECTORS: Sector[] = [
  ...
  { id: 2, name: 'Pescas', type: SectorType.Primario, description: 'Atividades de pesca industrial e artesanal.', cae: '031', categoryCount: 2, licenseCount: 2 },
  { id: 3, name: 'Indústrias Transformadoras', type: SectorType.Secundario, description: 'Transformação de matérias-primas.', categoryCount: 4, licenseCount: 8 },
  { id: 4, name: 'Construção Civil e Obras Públicas', type: SectorType.Secundario, description: 'Construção de edifícios e infraestruturas.', categoryCount: 1, licenseCount: 1 },
  { id: 5, name: 'Turismo', type: SectorType.Terciario, description: 'Alojamento, restauração e agências de viagens.', cae: '55, 56, 79', categoryCount: 9, licenseCount: 8 },
  { id: 6, name: 'Comércio', type: SectorType.Terciario, description: 'Comércio a grosso e a retalho.', categoryCount: 2, licenseCount: 1 },
  { id: 7, name: 'Indústrias Extrativas', type: SectorType.Primario, description: 'Extração de inertes, etc.', categoryCount: 1, licenseCount: 1 },
  { id: 8, name: 'Produção e Distribuição de Energia e Água', type: SectorType.Secundario, description: 'Produção e distribuição de eletricidade e água potável.', categoryCount: 1, licenseCount: 1 },
  { id: 9, name: 'Transportes', type: SectorType.Terciario, description: 'Transporte marítimo e aéreo de passageiros e carga.', categoryCount: 1, licenseCount: 0 },
  { id: 10, name: 'Serviços Financeiros', type: SectorType.Terciario, description: 'Bancos, seguros e outras atividades financeiras.', categoryCount: 0, licenseCount: 0 },
  { id: 11, name: 'Tecnologias de Informação e Comunicação (TIC)', type: SectorType.Terciario, description: 'Serviços de software, telecomunicações, etc.', categoryCount: 0, licenseCount: 0 },
];

export const CATEGORIES: Category[] = [
  { id: 1, name: 'Alojamento Turístico', sectorId: 5, licenseCount: 3 },
  { id: 2, name: 'Empreendimentos Hoteleiros', sectorId: 5, parentId: 1, codCAE: '55.1', licenseCount: 1 },
  { id: 3, name: 'Restauração e Bebidas', sectorId: 5, licenseCount: 2 },
  { id: 4, name: 'Pesca Industrial', sectorId: 2, codCAE: '03.11', licenseCount: 1 },
  { id: 5, name: 'Comércio a Retalho', sectorId: 6, licenseCount: 1 },
  { id: 6, name: 'Indústria Alimentar', sectorId: 3, licenseCount: 2 },
  { id: 7, name: 'Aldeamentos Turísticos', sectorId: 5, parentId: 1, codCAE: '55.2', licenseCount: 1 },
  { id: 8, name: 'Alojamento Local', sectorId: 5, parentId: 1, codCAE: '55.3', licenseCount: 1 },
  { id: 9, name: 'Restaurantes', sectorId: 5, parentId: 3, licenseCount: 1 },
  { id: 10, name: 'Bares e similares', sectorId: 5, parentId: 3, licenseCount: 1 },
  { id: 11, name: 'Agências de Viagens e Turismo', sectorId: 5, codCAE: '79.1', licenseCount: 1 },
  { id: 12, name: 'Animação Turística', sectorId: 5, codCAE: '79.9', licenseCount: 1 },
  { id: 13, name: 'Construção de Edifícios', sectorId: 4, codCAE: '41', licenseCount: 1 },
  { id: 14, name: 'Pesca Artesanal', sectorId: 2, codCAE: '03.12', licenseCount: 1 },
  { id: 15, name: 'Extração de Inertes', sectorId: 7, licenseCount: 1 },
  { id: 16, name: 'Produção de Energia Elétrica', sectorId: 8, licenseCount: 1 },
  { id: 17, name: 'Transporte Marítimo', sectorId: 9, licenseCount: 1 },
  { id: 18, name: 'Comércio por Grosso', sectorId: 6, licenseCount: 1 },
];
