  ...
  return (
    <div className="flex flex-col w-64 bg-gray-800 text-white">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        ...
        <NavLink to="/setores" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>
          <LayersIcon className="w-5 h-5" />
          <span className="mx-4 font-medium">Setores</span>
        </NavLink>
        <NavLink to="/categorias" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>
          <GridIcon className="w-5 h-5" />
          <span className="mx-4 font-medium">Categorias</span>
        </NavLink>
        <NavLink to="/licencas" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>
